"use client";
import { assets, theTruth } from '@/assets/assets'
          ...
          <div className='w-full items-center justify-center rounded-sm'>
            <div className='grid md:grid-cols-2 gap-2 mb-15'>
              ...
              <div className='text-2xl rounded-xl mt-5 max-w-2xl'>
                <p>Let me introduce myself, my name is Wahyu, this is my portfolio, I have worked as a <Link className='text-fuchsia-800 text-decoration-line: underline; text-2xl font-semibold' href="/Security">Security Guard</Link> for quite a long time, but on the other hand I am a Fresh Graduate of <Link className='text-cyan-400 text-decoration-line: underline; text-2xl font-semibold' href="/Developer">Informatics Engineering</Link>.</p>
              </div>
            </div>
          </div>
